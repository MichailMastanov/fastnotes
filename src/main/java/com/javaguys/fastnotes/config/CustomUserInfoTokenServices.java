package com.javaguys.fastnotes.config;
...
public class CustomUserInfoTokenServices implements ResourceServerTokenServices
{
	...
	public void setUserRepo(UserAccountRepository userAccountRepository)
	{
			...
			throws AuthenticationException, InvalidTokenException
	{
		...
		if(map.containsKey("sub"))
		{
			...
			user.setLastAuthDate(Timestamp.valueOf(LocalDateTime.now()));
			user.setEmail(email);
